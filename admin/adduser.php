...
<html lang="en">
  ...
  <div class="main">
    ...
    <input type="hidden" name="room" id="room" class="formInput" value="1234" style="padding: 4px 4px;margin: 2px 0;" required><br>

    <input type="hidden" name="ext" id="ext" class="formInput" value="1234" style="padding: 4px 4px;margin: 2px 0;" required><br>
